      ...
      <div className="relative p-4 w-full max-w-md max-h-full mx-auto my-8">
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div className="p-4 md:p-5 text-center">
            ...
            <a
              href="/cv-sample.pdf"
              className="text-white bg-custom-green hover:bg-custom-green-hover-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center"
              aria-current="page"
            >
              Español
            </a>
